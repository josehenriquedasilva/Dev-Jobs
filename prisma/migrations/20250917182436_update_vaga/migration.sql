/*
  ...
  - The values [PRECENSIAL] on the enum `ModalidadeDeAtuacao` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."ModalidadeDeAtuacao_new" AS ENUM ('PRESENSIAL', 'REMOTO', 'HIBRIDO');
